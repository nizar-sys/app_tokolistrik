...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url('data-cabang/store') ?>" method="post">
                <?= csrf_field() ?>
                <div class="row mb-3">
                    <label for="cabang" class="col-sm-2 col-form-label">Nama Cabang</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= validation_errors('cabang') ? 'is-invalid' : '' ?>" name="cabang" id="cabang" autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control <?= validation_errors('alamat') ? 'is-invalid' : '' ?>" name="alamat" id="alamat" rows="4" autocomplete="off"></textarea>
                    ...
                    <div class="col-sm-10">
                        <select class="form-select <?= validation_errors('owner_id') ? 'is-invalid' : '' ?>" name="owner_id" id="owner_id">
                            ...
                            <?php foreach ($owners as $owner) : ?>
                                <option value="<?= $owner->user_id ?>"><?= $owner->nama_lengkap ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-sm-10">
                        <select class="form-select <?= validation_errors('admin_id') ? 'is-invalid' : '' ?>" name="admin_id" id="admin_id">
                            ...
                            <?php foreach ($admins as $admin) : ?>
                                <option value="<?= $admin->user_id ?>"><?= $admin->nama_lengkap ?></option>
                            <?php endforeach; ?>
                        </select>
