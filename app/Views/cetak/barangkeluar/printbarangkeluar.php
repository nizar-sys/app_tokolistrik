        ...
        <tbody>
            ...
            <?php foreach ($result as $row) : ?>
                <tr>
                    ...
                    <td style="font-size: 15px; padding: 10px"><?= $row['invoice'] ?></td>
                    <td style="font-size: 15px; padding: 10px"><?= $row['nama_barang'] ?></td>
                    <td style="font-size: 15px; padding: 10px"><?= $row['harga_jual'] ?></td>
                    <td style="font-size: 15px; padding: 10px"><?= $row['harga_beli'] ?></td>
                    <td style="font-size: 15px; padding: 10px"><?= $row['jumlah'] ?></td>
                    <td style="font-size: 15px; padding: 10px"><?= $row['subtotal'] ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
