        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url('rak/create') ?>" class="btn btn-primary">Tambah Data</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($results as $res) : ?>
                                <tr>
                                    ...
                                    <td><?= $res->lokasi ?></td>
                                    <td>
                                        <a href="<?= base_url('rak/edit/' . $res->rak_id) ?>" class="btn btn-info btn-sm">
                                            <i class="align-middle bx bx-edit"></i>
                                        </a>
                                        <form action="rak/delete/<?= $res->rak_id ?>" method="post" class="d-inline">
                                            <?= csrf_field() ?>
