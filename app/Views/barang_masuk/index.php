...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Data Invoice Barang Masuk</h5>
            <a href="<?= base_url('barangmasuk/create') ?>" class="btn btn-primary">
                    ...
                    <?php foreach ($invoice as $inv) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                $jumlahItem = $db->table('tb_barangmasuk')->where('invoice', $inv->invoice)->countAllResults();
                                ?>
                            ...
                            <td>
                                <?php
                                $db = \Config\Database::connect();
                                $query = $db->table('tb_barangmasuk')->where('invoice', $inv->invoice)->get();
...
<script>
    function edit(invoice) {
        window.location.href = ('<?= base_url() ?>barangmasuk/edit/') + invoice;
    }
</script>
<?= $this->endSection() ?>