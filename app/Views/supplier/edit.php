    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('supplier/update/' . $res->supplier_id) ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="row mb-3">
                            <label for="nama_lengkap" class="col-sm-2 col-form-label">Nama Lengkap</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= validation_errors('nama_lengkap') ? 'is-invalid' : '' ?>" name="nama_lengkap" id="nama_lengkap" autocomplete="off" value="<?= $res->nama_supplier ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control <?= validation_errors('no_telpon') ? 'is-invalid' : '' ?>" name="no_telpon" id="no_telpon" autocomplete="off" value="<?= $res->no_telpon ?>">
