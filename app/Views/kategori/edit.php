    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('kategori/update/' . $res->kategori_id) ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="row mb-3">
                            <label for="nama_kategori" class="col-sm-2 col-form-label">Nama Kategori</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= validation_errors('nama_kategori') ? 'is-invalid' : '' ?>" name="nama_kategori" id="nama_kategori" autocomplete="off" value="<?= $res->nama_kategori ?>">
